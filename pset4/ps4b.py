...
def compPlayHand(hand, wordList, n):
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            total += wordPoints
            print '"' + word + '" earned ' + str(wordPoints) + ' points. Total: ' + str(total) + ' points\n'   
            # Update the hand
...
def playGame(wordList):
    ...
    while True:
        ...
        if gameChoice == 'e':
            return None
        elif gameChoice == 'r' and len(hand) == 0:
            print 'You have not played a hand yet. Please play a new hand first!'
        elif gameChoice != 'n' and gameChoice != 'r':
            print 'Invalid command.'
        else:
            playChoice = raw_input('Enter u to have yourself play, c to have the computer play: ')
            while playChoice != 'u' and playChoice != 'c':
                print 'Invalid command.'
                playChoice = raw_input('Enter u to have yourself play, c to have the computer play: ')
            if playChoice == 'u' or playChoice == 'c':
                if gameChoice == 'n':
